...
languageRouter.get(
    ...
    async (req, res, next) => {
        try {
            ...
            const language = await languageService.getLanguage({ _id });
...
languageRouter.put(
    ...
    async (req, res, next) => {
        try {
            ...
            const updatedLanguage = await languageService.setLanguage({_id, toUpdate});
...
languageRouter.delete(
    ...
    async (req, res, next) => {
        try {
            const result = await languageService.removeLanguage({ _id: req.params.id });
            res.json(result);
        } catch (error) {
            next(error);
        }
